...
Tracks **60 road projects** across Ghana — 54 confirmed contracts from the Ministry of Roads & Highways' own "Full List of Big Push Infrastructure Programme" (including real per-contract kilometre lengths), plus 6 further roads from the MRH official authorization list that are still awaiting full contract disclosure.
...
| Source | Description |
|--------|-------------|
| **GHA Official List — "Full List of Big Push Infrastructure Programme"** | 54 sole-sourced contracts, including real per-contract kilometre lengths |
| **MRH Official Big Push Authorization List** | 6 further roads officially authorized but not yet publicly disclosed |
